...
<div style="padding: 10px 10px;">
    <form id="data-form" class="layui-form layui-form-pane" onsubmit="return false;">
        {{csrf_field()}}
        <div class="layui-form-item">
            <label class="layui-form-label">角色名</label>
            <div class="layui-input-block">
                <input type="text" name="name" autocomplete="off" placeholder="请输入角色名" class="layui-input">
            </div>
        </div>
            ...
            function RoleEvent(){
                this.add = function(){
                    $('button[type="button"]').click(function(){
                        $.post('{{route("admin::Admin.Power.addRole")}}',$('#data-form').serialize(),function(data,textStatus){
