    ...
    <form  id="data-form" onsubmit="return false;">
            ...
            <div class="layui-input-block">
                <select name="parent_id" lay-verify="required" lay-search="">
                    ...
                    @foreach ($privilege_list as $privilege_key => $privilege_child)
                        <option value="{{$privilege_child['p_id']}}">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="module_name" lay-verify="pass" placeholder="目前统一填admin" autocomplete="off" class="layui-input">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="route_name"   placeholder="例如：admin::Admin.Power.index" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="action_name"  placeholder="例如：Admin\PowerController@index" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="style_name"  placeholder="请输入样式名称" autocomplete="off" class="layui-input">
            </div>
        ...
        function RuleEvent(){
            this.add = function(){
                $('button[type="button"]').click(function(){
                    $.post('{{route("admin::Admin.Power.addRule")}}',$('#data-form').serialize(),function(data,textStatus){
